...
export default function NavBar() {
  ...
  return (
    <header className="flex justify-center fixed bottom-2 w-screen z-[11]">
      <motion.nav className="dark:bg-white bg-[#480ca8] shadow-2xl rounded-full px-4 py-2 w-fit">
            ...
            >
              ...
              >
                ...
                {link.name === activeSection && (
                  <motion.span
                    className={`bg-[#f0f0f0] rounded-full w-1 h-1 absolute -bottom-1  dark:bg-[#480ca8]`}
